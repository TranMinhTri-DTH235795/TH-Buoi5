...
{
    public partial class frmNhanhVien : Form
    {
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            foreach (DataRow r in table.Rows)
                            {
                                ...
                                context.NhanVien.Add(nv);
                                nv.MatKhau= BCrypt.Net.BCrypt.HashPassword(r["MatKhau"].ToString());
                                context.NhanVien.Add(nv);
                                nv.DienThoai = r["DienThoai"].ToString();
                                context.NhanVien.Add(nv);
                                nv.DiaChi = r["DiaChi"].ToString();
                                context.NhanVien.Add(nv);
                                nv.QuyenHan = r["QuyenHan"].ToString().ToLower() == "true" ? true : false;
                                context.NhanVien.Add(nv);
                            }
                            context.SaveChanges();
